  ...
  en: {
    ...
    home: {
      ...
      steps: [
        ...
        { title: "Match", description: "We find the right engineer from our vetted network within 48 hours." },
    ...
    servicesPage: {
      ...
      services: [
        ...
        { title: "Staff Augmentation", description: "Scale your engineering team with pre-vetted senior professionals. B2B contract model with Reverse Charge for EU clients — no employer taxes, no overhead. Rapid onboarding within 48 hours.", features: ["Data Engineers & Architects", "Cloud & DevOps Specialists", "Databricks & Snowflake Experts", "B2B Contract Model (Reverse Charge)", "Rapid Onboarding — 48h to Start"] },
  ...
  de: {
    ...
    home: {
      ...
      steps: [
        ...
        { title: "Matching", description: "Wir finden den richtigen Ingenieur aus unserem geprüften Netzwerk innerhalb von 48 Stunden." },
  ...
  fr: {
    ...
    home: {
      ...
      steps: [
        ...
        { title: "Matching", description: "Nous trouvons le bon ingénieur dans notre réseau vérifié sous 48 heures." },
    ...
    servicesPage: {
      ...
      services: [
        ...
        { title: "Renforcement d'équipe", description: "Renforcez votre équipe d'ingénierie avec des professionnels seniors vérifiés. Modèle B2B avec autoliquidation pour les clients UE.", features: ["Data Engineers & Architectes", "Spécialistes Cloud & DevOps", "Experts Databricks & Snowflake", "Modèle B2B (Autoliquidation)", "Intégration rapide — 48h pour démarrer"] },
  ...
  es: {
    ...
    home: {
      ...
      steps: [
        ...
        { title: "Match", description: "Encontramos al ingeniero adecuado de nuestra red verificada en 48 horas." },
  ...
  it: {
    ...
    home: {
      ...
      steps: [
        ...
        { title: "Match", description: "Troviamo l'ingegnere giusto dalla nostra rete verificata entro 48 ore." },
  ...
  ru: {
    ...
    home: {
      ...
      steps: [
        ...
        { title: "Подбор", description: "Мы найдём подходящего инженера из нашей проверенной сети за 48 часов." },
    ...
    servicesPage: {
      ...
      services: [
        ...
        { title: "Усиление команд", description: "Усильте инженерную команду проверенными senior-специалистами. B2B-модель с reverse charge для клиентов из ЕС.", features: ["Data Engineers и архитекторы", "Cloud- и DevOps-специалисты", "Эксперты Databricks и Snowflake", "B2B-модель (Reverse Charge)", "Быстрый онбординг — 48ч до старта"] },
  ...
  uk: {
    ...
    home: {
      ...
      steps: [
        ...
        { title: "Підбір", description: "Ми знайдемо відповідного інженера з нашої перевіреної мережі за 48 годин." },
    ...
    servicesPage: {
      ...
      services: [
        ...
        { title: "Підсилення команд", description: "Підсильте інженерну команду перевіреними senior-фахівцями. B2B-модель з reverse charge для клієнтів з ЄС.", features: ["Data Engineers та архітектори", "Cloud- та DevOps-спеціалісти", "Експерти Databricks та Snowflake", "B2B-модель (Reverse Charge)", "Швидкий онбординг — 48г до старту"] },
  ...
  pt: {
    ...
    home: {
      ...
      steps: [
        ...
        { title: "Match", description: "Encontramos o engenheiro certo na nossa rede verificada em 48 horas." },
